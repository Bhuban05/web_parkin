        ...
        >
            ...
            {menuOpen && (
              ...
              >
                ...
                <a
                  ...
                  className="flex items-center gap-3 rounded-full bg-white pl-5 pr-4 py-3 shadow-card-hover border border-navy/8 hover:shadow-lg transition-all duration-200 group"
                >
                  <span className="text-sm font-semibold text-navy whitespace-nowrap">Call us</span>
                ...
                <a
                  ...
                  className="flex items-center gap-3 rounded-full bg-white pl-5 pr-4 py-3 shadow-card-hover border border-navy/8 hover:shadow-lg transition-all duration-200 group"
                >
                  <span className="text-sm font-semibold text-navy whitespace-nowrap">Email us</span>
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-brand text-white shadow-sm">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <a
                  ...
                  className="flex items-center gap-3 rounded-full bg-white pl-5 pr-4 py-3 shadow-card-hover border border-navy/8 hover:shadow-lg transition-all duration-200 group"
                >
                  <span className="text-sm font-semibold text-navy whitespace-nowrap">WhatsApp</span>
          ...
          <motion.button
            ...
            className={`flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-all duration-300 ${
              menuOpen
                ? "bg-navy text-white shadow-navy/30 rotate-45"
                : "bg-[#25D366] text-white shadow-[#25D366]/30"
            }`}
            aria-label={menuOpen ? "Close menu" : "Open contact menu"}
          >
            {menuOpen ? (
